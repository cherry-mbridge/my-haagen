...
return [
    ...
    */
    ...
    // Note: This package-native refresh_ttl is NOT used by our custom refresh-token flow.
    // We use database-stored refresh tokens with cookie transport (see auth.php / MemberAuthService).
